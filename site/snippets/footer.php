          ...
          <div class="pure-g">
              <div class="pure-u-1">
                  <ul class="linklist">
                      ...
                      <li><span>Socials</span><?php $socialsCount = $socials->count(); $i = 0; foreach($socials as $social) : ?><a rel="me" href="<?= $social->link()->toHtml() ?>"><?= $social->platform() ?></a><?php if (++$i < $socialsCount) : ?> / <?php endif ?><?php endforeach ?></li>
                      <?php endif ?>
